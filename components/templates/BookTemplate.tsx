...
export function BookTemplate({ catalog }: { catalog: Catalog }) {
  return <div className="mx-auto max-w-5xl px-4 pb-16"><div className="hidden justify-center md:flex">
    <HTMLFlipBook width={460} height={650} size="stretch" minWidth={320} maxWidth={460} minHeight={460} maxHeight={650} showCover mobileScrollSupport className="shadow-2xl" style={{}} startPage={0} drawShadow flippingTime={700} usePortrait startZIndex={0} autoSize maxShadowOpacity={0.35} clickEventForward={false} useMouseEvents swipeDistance={30} showPageCorners disableFlipByClick={false}>
